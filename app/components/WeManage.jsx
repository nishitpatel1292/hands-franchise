...
const WeManage = () => {
    return (
        <section className="min-h-screen bg-slate-50 text-center py-20 px-8 xl:px-0 flex flex-col justify-center">
            <span className="text-gray-600 text-lg max-w-lg mx-auto mb-2 capitalize flex items-center">what we're managing <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="text-indigo-600 ml-3 w-6 h-6">
