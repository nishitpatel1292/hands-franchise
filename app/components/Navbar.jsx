...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-50 backdrop-blur-sm transition-colors duration-300 ${!isScrolled ? 'bg-transparent' : 'bg-white'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center">
            <Building2 className="h-8 w-8 text-blue-600" />
            <span className={`ml-2 text-xl font-bold ${isScrolled ? 'text-black hover:text-blue-600' : 'text-white hover:text-blue-600'}`}>H&S Franchise</span>
          </div>
      ...
      {isMenuOpen && (
        ...
        >          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white">
            <a href="#" className="block px-3 py-2 text-white hover:text-blue-600 transition-colors">Solutions</a>
            <a href="#" className="block px-3 py-2 text-white hover:text-blue-600 transition-colors">Services</a>
            <a href="#" className="block px-3 py-2 text-white hover:text-blue-600 transition-colors">About</a>
            <a href="#" className="block px-3 py-2 text-white hover:text-blue-600 transition-colors">Contact</a>
