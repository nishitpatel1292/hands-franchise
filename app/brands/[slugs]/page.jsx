...
const franchiseData = {
  hoccoEatery: {
    ...
    locations: [
      {
        url: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3672.6319891508265!2d72.5061748!3d23.0005564!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9bd5f9a646db%3A0x5ff37f40cb89fa8b!2sHocco%20Eatery!5e0!3m2!1sen!2sin!4v1737394136379!5m2!1sen!2sin",
        locationName: "Makarba",
      },
      {
        url: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58694.16674258091!2d72.59302097977942!3d23.15612909431003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e8194a7411881%3A0x739b636940d1ddaa!2shocco%20eatry!5e0!3m2!1sen!2sin!4v1737394656651!5m2!1sen!2sin",
        locationName: "Bhaijipura",
      },
    ],
    gallery: [
  ...
  hoccoIcecream: {
    ...
    locations: [
      {
        url: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117524.7896871604!2d72.3536168972656!3d22.99990630000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9b00149f940d%3A0x7f561de6c03092fb!2sH%20%26%20S%20FRANCHISES%20DIST_%20HOCCO%20ICE%20CREAM!5e0!3m2!1sen!2sin!4v1737611430160!5m2!1sen!2sin",
        locationName: "Makarba",
      },
    ],
    investment: "₹2Cr",
    revenue: "₹6Cr average annual turnover",
    employeeCount: "6 per location",
  ...
  chhaswala: {
    ...
    locations: [
      {
        url: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29373.62647752157!2d72.51418504520062!3d23.034663360732683!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9bee2a90484d%3A0x9bc1bd26afbe91fa!2sChhaswala-%20iscon!5e0!3m2!1sen!2sin!4v1737611567855!5m2!1sen!2si",
        locationName: "Satellite",
      },
    ],
    investment: "₹30 lakhs",
    revenue: "₹12 lakhs average annual turnover",
    employeeCount: "2 per location",
    gallery: ["/franchises/chhaswala/chhaswala.jpg"],
  },
  pigeon: {
    name: "Pigeon",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold mb-2">Since</h3>
            <p className="text-gray-600">{franchise.startDate}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="max-w-7xl mx-auto pb-16 px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold mb-4 flex align-middle gap-3">
          <Store size={35} /> Our Franchise Locations
        </h2>
        <div className="flex flex-col gap-4">
          {franchise?.locations?.map((item, index) => (
            <div key={index}>
              <div className="my-4 flex gap-2 justify-start">
                <MapPin /> {item.locationName}
              </div>
      ...
      <div className="max-w-7xl mx-auto pb-16 px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold mb-4 flex align-middle gap-3">
          <GalleryHorizontalEnd size={35} /> Gallery
        </h2>{" "}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          {franchise.gallery.map((image, index) => (
            <div
              key={index}
              className="aspect-w-16 aspect-h-9 max-h-[600px] rounded-lg overflow-hidden"
            >
              <img
                src={image}
